    ...
    <>
      ...
      <div className="flex items-center overflow-x-auto whitespace-nowrap lg:overflow-hidden">
        {PopularArtistsMocks.map((item) => (
          <div
            key={item.id}
            className="flex flex-col cursor-pointer rounded-lg p-2 transition duration-300 hover:bg-[#222] lg:hover:bg-gradient-to-t lg:hover:from-[#222] lg:hover:to-transparent lg:px-3 lg:pt-3 lg:pb-4"
          >
            <img
